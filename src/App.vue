...
<template>
  ...
  <div class="grid lg:grid-cols-2 h-screen  ">
    <div class="flex xl:inline ">
      <!-- backgrounds -->
      <img src="/image/bg-main-desktop.png" alt="desktop backgrorund" class="lg:inline sm:hidden lg:row-span-2 w-3/5 h-screen ">
      <img src="/image/bg-main-mobile.png" alt="mobile background" class="lg:hidden sm:inline sm:w-full sm:h-[270px]">
      <!-- front card -->
      <div class="absolute xl:top-[17%] lg:top-[15%] xl:left-[12%] lg:left-[7%] text-slate-50 font-spaceMedium z-20 ">
        <img src="image/bg-card-front.png" alt="card front" class="xl:w-[430px] lg:w-[370px]">
        <img src="image/card-logo.svg" alt="card logo"
          class="absolute xl:top-[10%] xl:left-[10%] lg:top-[10%] lg:left-[10%] lg:w-[70px]">
        <p
          class="inline  absolute xl:bottom-[30%] xl:text-3xl  xl:left-[9%] tracking-widest lg:bottom-[29%] lg:left-[11%] lg:text-2xl">
          9591 6489 6389 101E</p>
        <!-- card holder name -->
        <p class="absolute lg:bottom-[10%] lg:left-[10%] ">FELICA LEIRE</p>
        <span class="absolute lg:right-[10%] lg:bottom-[10%]">
          <p class="inline">09</p> / <p class="inline">00</p>
        </span>
      </div>
      <!-- back cart -->
      <div class="absolute lg:bottom-[15%]   xl:left-[17%] lg:left-[14%] xl:w-[430px] lg:w-[370px] md:w-[300px]">
        <img src="/image/bg-card-back.png" class="" alt="">
        <p
          class="absolute xl:top-[100px] font-spaceMedium tracking-wider xl:right-12 text-xl text-slate-50 lg:top-[85px] lg:right-10 ">
          000</p>
      </div>
    </div>
    <!-- inputs -->
    <div class="flex  items-center xl:justify-center justify-center   ">
